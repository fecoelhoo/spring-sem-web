package br.com.felipespring.screen.principal;

import br.com.felipespring.screen.model.DadosEpisodio;
import br.com.felipespring.screen.model.DadosSerie;
import br.com.felipespring.screen.model.DadosTemporada;
import br.com.felipespring.screen.model.Episodio;
import br.com.felipespring.screen.model.Episodio;
...
//                .forEach(System.out::println);
      ...
      episodios.forEach(System.out::println);
        ...
        if(episodioBuscado.isPresent()){
            System.out.println("Epsiodio encontrado");
            System.out.println("Temporada " + episodioBuscado.get().getTemporada());
        } else {
            System.out.println("Episodio não encontrado");
        }

//        System.out.println("A partir de que ano você quer assitir os episodios?");
